...
def test_inverse_due_north():
    p1 = Point(1000.0, 1000.0)
    p2 = Point(1100.0, 1000.0)
...
def test_inverse_with_elevation():
    p1 = Point(0.0, 0.0, 100.0)
    p2 = Point(300.0, 400.0, 200.0)
    result = inverse(p1, p2)
...
def test_inverse_area_points():
    ...
    p10 = Point(3000.0000, 3000.0000)
    p11 = Point(2979.0430, 3000.1800)
...
def test_inverse_compass_closure():
    ...
    p20 = Point(3102.894, 3125.949)
    p26 = Point(3102.885, 3125.942)
