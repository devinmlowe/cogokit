...
from cogopro.tui.widgets.form_fields import SelectField, TextField
...
class LoadPointsScreen(Screen):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        try:
            ...
            if fmt == "landxml":
                from cogopro.io.landxml import import_landxml
                loaded_job = import_landxml(p)
            else:
                from cogopro.io import read_points
...
class ExportScreen(Screen):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        try:
            ...
            if fmt == "ascii":
                from cogopro.io import Delimiter, write_points
                ...
                from cogopro.io import export_dxf
                export_dxf(self.app.current_job, out_path)
            elif fmt == "kml":
                from cogopro.io import export_kml
