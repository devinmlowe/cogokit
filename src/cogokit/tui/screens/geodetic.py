...
from cogokit.tui.widgets.form_fields import FloatField, SelectField, TextField
...
class VincentyDirectScreen(Screen):
    ...
    def _get_ellipsoid(self):
        from cogokit.geodetic.ellipsoid import CLARKE_1866, GRS80, WGS84
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        try:
            from cogokit.geodetic.vincenty import vincenty_direct
...
class VincentyInverseScreen(Screen):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        try:
            from cogokit.geodetic.vincenty import vincenty_inverse
...
class ConvertScreen(Screen):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        try:
            ...
            from cogokit.core.crs import transform_point
